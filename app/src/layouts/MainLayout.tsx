            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <aside className={`${sidebarOpen ? 'w-64' : 'w-0'} transition-all duration-300 overflow-hidden bg-white border-r border-gray-200 flex flex-col`}>
                    <nav className="p-4 space-y-2 flex-1">
                        <Link to="/" className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-100 text-gray-700 font-medium">
                            <LayoutDashboard size={20} className="text-blue-600" />
                            <span>Dashboard</span>
                        </Link>
                        <Link to="/technicians" className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-100 text-gray-700 font-medium">
                            <Wrench size={20} className="text-blue-600" />
                            <span>Technicians</span>
                        </Link>
                        <Link to="/calendar" className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-100 text-gray-700 font-medium">
                            <CalendarIcon size={20} className="text-blue-600" />
                            <span>Calendar</span>
                        </Link>
                        <Link to="/reports" className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-100 text-gray-700 font-medium">
